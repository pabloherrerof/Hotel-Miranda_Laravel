          ...
          <form method="POST" action="/room-detail/{{$room->id}}" class="room-detail__form">
            ...
            <div class="room-detail__input-container">
              <label
                ...
                >Personal Info</label
              >
              <div class="contact-form__inputs contact-form__inputs--room">
              ...
              <div class="contact-form__message">
                ...
                <input type="text" name="specialRequest" class="contact-form__input contact-form__input--msg" placeholder="Enter message" required>
              </div>
